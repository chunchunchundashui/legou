    ...
    <div class="page-content">
      ...
      <div class="page-body">
        ...
        <button type="button" tooltip="添加商品" class="btn btn-sm btn-azure btn-addon"
                onClick="javascript:window.location.href = '<?php echo url('admin/Goods/add'); ?>'"><i class="fa fa-plus"></i> Add
        </button>
        <div class="row">
                ...
                <div class="flip-scroll">
                  <form action="" method="post">
                    <table class="table table-bordered table-hover">
                      ...
                      <tbody>
                      <?php if(is_array($goodsLst) || $goodsLst instanceof \think\Collection || $goodsLst instanceof \think\Paginator): $i = 0; $__LIST__ = $goodsLst;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$goods): $mod = ($i % 2 );++$i;?>
                      <tr>
                        <td align="center"><?php echo $goods['id']; ?></td>
                        <td align="center"><?php echo $goods['goods_name']; ?></td>
                        <td align="center"><img src="/legou/public/static/uploads/<?php echo $goods['thumb']; ?>" alt="<?php echo $goods['goods_name']; ?>" height="30px"></td>
                        ...
                        <td align="center"><?php echo $goods['sale_num']; ?></td>
                        <td align="center"><?php echo $goods['stock_num']; ?></td>
                        <td align="center"><?php echo $goods['weight']; ?><?php echo $goods['weight_unit']; ?></td>
                        <td align="center">
                          <a href="<?php echo url('admin/Goods/edit',array('id' =>$goods['id'])); ?>" class="btn btn-primary btn-sm shiny">
                            <i class="fa fa-edit"></i> 编辑
                          </a>
                          <a href="javascript:void(0);" onclick="delBanner(this,'<?php echo $goods['id']; ?>')"
...
<script>
  $('input[name=sort]').change(function () {
    ...
    var sort = $(this).val();
    $.ajax({
      url:"<?php echo url('admin/Goods/lst'); ?>",
      type:'post',
  ...
  function delBanner(obj,id){
    layer.confirm('确认要删除吗？',function(index){
      ...
      //发异步删除数据
      $.post("<?php echo url('admin/Goods/del'); ?>",{id:id},function (data) {
        if(data.code == 1){
          div.remove();
          //删除成功 删除元素
