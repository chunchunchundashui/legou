<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:68:"D:\phpStudy\WWW\legou\public/../application/admin\view\cate\list.htm";i:1605010100;s:59:"D:\phpStudy\WWW\legou\application\admin\view\common\top.htm";i:1604586869;s:60:"D:\phpStudy\WWW\legou\application\admin\view\common\left.htm";i:1605340289;s:58:"D:\phpStudy\WWW\legou\application\admin\view\common\js.htm";i:1604588515;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
    ...
    <div class="page-content">
      ...
      <div class="page-body">
        ...
        <button type="button" tooltip="添加栏目" class="btn btn-sm btn-azure btn-addon"
                onClick="javascript:window.location.href = '<?php echo url('admin/Cate/add'); ?>'"><i class="fa fa-plus"></i> Add
        </button>
        <div class="row">
                ...
                <div class="flip-scroll">
                  <form action="" method="post">
                    <table class="table table-bordered table-hover">
                      ...
                      <tbody>
                      <?php if(is_array($cateLst) || $cateLst instanceof \think\Collection || $cateLst instanceof \think\Paginator): $i = 0; $__LIST__ = $cateLst;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cate): $mod = ($i % 2 );++$i;?>
                      <tr>
                        <td align="center"><?php echo $cate['id']; ?></td>
                        <td><?php echo str_repeat('-', $cate['level']*8)?><?php echo $cate['cate_name']; ?></td>
                        <td align="center"><img src="/legou/public/static/uploads/<?php echo $cate['thumb']; ?>" alt="<?php echo $cate['cate_name']; ?>" height="30px"></td>
                        <td align="center"><input type="text" style="width: 60px; text-align: center" name="sort" dataid="<?php echo $cate['id']; ?>" value="<?php echo $cate['sort']; ?>"></td>
                        <td align="center">
                          <a href="<?php echo url('admin/Cate/edit', array('id'=> $cate['id'])); ?>" class="btn btn-primary btn-sm shiny">
                            <i class="fa fa-edit"></i> 编辑
                          </a>
                          <a href="javascript:void(0);" onclick="delBanner(this,'<?php echo $cate['id']; ?>')" class="btn btn-danger btn-sm shiny">
...
<script>
  $('input[name=sort]').change(function () {
    ...
    var sort = $(this).val();
    $.ajax({
      url:"<?php echo url('admin/Cate/lst'); ?>",
      type:'post',
  ...
  function delBanner(obj,id){
    layer.confirm('确认要删除吗？',function(index){
      ...
      //发异步删除数据
      $.post("<?php echo url('admin/Cate/del'); ?>",{id:id},function (data) {
        if(data.code == 1){
          div.remove();
          //删除成功 删除元素
