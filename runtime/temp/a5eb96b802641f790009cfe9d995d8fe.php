<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:71:"D:\phpStudy\WWW\legou\public/../application/admin\view\special\edit.htm";i:1605343876;s:59:"D:\phpStudy\WWW\legou\application\admin\view\common\top.htm";i:1604586869;s:60:"D:\phpStudy\WWW\legou\application\admin\view\common\left.htm";i:1605340289;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
    ...
    <div class="page-content">
      ...
      <div class="page-breadcrumbs">
        <ul class="breadcrumb">
          ...
          <li>
            <a href="<?php echo url('admin/Special/lst'); ?>">专题列表</a>
          </li>
          ...
          <div class="col-lg-12 col-sm-12 col-xs-12">
            <div class="widget">
              <div class="widget-header bordered-bottom bordered-blue">
                <span class="widget-caption">新增专题</span>
              </div>
              <div class="widget-body">
                <div id="horizontal-form">
                  <form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="id" value="<?php echo $specialEdit['id']; ?>">
                    <div class="form-group">
                      <label for="username" class="col-sm-2 control-label no-padding-right">专题名称</label>
                      <div class="col-sm-6">
                        <input class="form-control" id="username" placeholder="" value="<?php echo $specialEdit['spe_name']; ?>" name="spe_name" type="text">
                      </div>
                      <p class="help-block col-sm-4 red">* 必填</p>
                    </div>
                    <div class="form-group">
                      <label for="username" class="col-sm-2 control-label no-padding-right">专题图片</label>
                      <div class="col-sm-6">
                        <input class="form-control" id="username" placeholder="" name="spe_img" type="file"
                               style="border: none; box-shadow: none">
                        <?php if($specialEdit != ''): ?>
                        <img src="/legou/public/static/uploads/special/<?php echo $specialEdit['spe_img']; ?>" alt="" width="60">
                        <?php else: ?>
                        暂无图片
                        <?php endif; ?>
                      </div>
                      ...
                      <div class="col-sm-6">
                        <div class="radio">
                          <label style="margin-right: 20px">
                            <input name="status" value="1" type="radio" <?php if($specialEdit['status'] == 1): ?> checked="checked" <?php endif; ?> class="colored-blue">
                            <span class="text">显示</span>
                          </label>
                          <label>
                            <input name="status" value="0" type="radio" <?php if($specialEdit['status'] == 0): ?> checked="checked" <?php endif; ?> class="colored-blue">
