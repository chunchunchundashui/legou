<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:71:"D:\phpStudy\WWW\legou\public/../application/admin\view\special\list.htm";i:1605344039;s:59:"D:\phpStudy\WWW\legou\application\admin\view\common\top.htm";i:1604586869;s:60:"D:\phpStudy\WWW\legou\application\admin\view\common\left.htm";i:1605340289;s:58:"D:\phpStudy\WWW\legou\application\admin\view\common\js.htm";i:1604588515;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
    ...
    <div class="page-content">
      ...
      <div class="page-body">
        ...
        <button type="button" tooltip="添加用户" class="btn btn-sm btn-azure btn-addon"
                onClick="javascript:window.location.href = '<?php echo url('admin/Special/add'); ?>'"><i class="fa fa-plus"></i> Add
        </button>
        <div class="row">
                ...
                <div class="flip-scroll">
                  <form action="" method="post">
                    <table class="table table-bordered table-hover">
                      ...
                      <tbody>
                      <?php if(is_array($specialLst) || $specialLst instanceof \think\Collection || $specialLst instanceof \think\Paginator): $i = 0; $__LIST__ = $specialLst;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$special): $mod = ($i % 2 );++$i;?>
                      <tr>
                        <td align="center"><?php echo $special['id']; ?></td>
                        <td align="center"><?php echo $special['spe_name']; ?></td>
                        <td align="center"><img src="/legou/public/static/uploads/special/<?php echo $special['spe_img']; ?>" alt="<?php echo $special['spe_name']; ?>" height="30px"></td>
                        <td align="center"><?php if($special['status'] == 1): ?>
                          显示
                          <?php else: ?>
                          隐藏
                          <?php endif; ?></td>
                        <td align="center">
                          <a href="<?php echo url('admin/Special/edit',array('id' =>$special['id'])); ?>" class="btn btn-primary btn-sm shiny">
                            <i class="fa fa-edit"></i> 编辑
                          </a>
                          <a href="javascript:void(0);" onclick="delBanner(this,'<?php echo $special['id']; ?>')"
...
<script>
  function delBanner(obj,id){
    layer.confirm('确认要删除吗？',function(index){
      ...
      //发异步删除数据
      $.post("<?php echo url('admin/Special/del'); ?>",{id:id},function (data) {
        if(data.code == 1){
          div.remove();
          //删除成功 删除元素
