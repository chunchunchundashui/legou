<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:70:"D:\phpStudy\WWW\legou\public/../application/admin\view\banner\edit.htm";i:1604677779;s:59:"D:\phpStudy\WWW\legou\application\admin\view\common\top.htm";i:1604586869;s:60:"D:\phpStudy\WWW\legou\application\admin\view\common\left.htm";i:1605340289;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
    ...
    <div class="page-content">
      ...
      <div class="page-breadcrumbs">
        <ul class="breadcrumb">
          ...
          <li>
            <a href="<?php echo url('admin/Banner/lst'); ?>">图片列表</a>
          </li>
              ...
              <div class="widget-body">
                <div id="horizontal-form">
                  <form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="id" value="<?php echo $bannerEdit['id']; ?>">
                    <div class="form-group">
                      <label for="username" class="col-sm-2 control-label no-padding-right">标题</label>
                      <div class="col-sm-6">
                        <input class="form-control" id="username" <?php if($bannerEdit['title'] == ''): ?> placeholder="空值" <?php endif; ?> name="title" value="<?php echo $bannerEdit['title']; ?>" type="text">
                      </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-6">
                        <input class="form-control" id="username" placeholder="" name="img_src" type="file"
                               style="border: none; box-shadow: none">
                        <?php if($bannerEdit['img_src'] == ''): ?>
                        暂无图片
                        <?php else: ?>
                        <img src="/legou/public/static/uploads/<?php echo $bannerEdit['img_src']; ?>" alt="<?php echo $bannerEdit['title']; ?>" height="30">
                        <?php endif; ?>
                      </div>
                      <p class="help-block col-sm-4 red">* 必填</p>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-sm-6">
                        <input class="form-control" id="username" value="<?php echo $bannerEdit['link_url']; ?>" placeholder="" name="link_url"
                               type="text">
                      </div>
                      <p class="help-block col-sm-4 red">* 必填</p>
                    </div>
                      ...
                      <div class="col-sm-6">
                        <div class="radio">
                          <label style="margin-right: 20px">
                            <input name="type" value="1" type="radio" <?php if($bannerEdit['type'] == 1): ?> checked="checked" <?php endif; ?> class="colored-blue">
                            <span class="text">商品</span>
                          </label>
                          <label>
                            <input name="type" value="2" type="radio" <?php if($bannerEdit['type'] == 2): ?> checked="checked" <?php endif; ?> class="colored-blue">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-6">
                        <textarea class="form-control" name="description" id="" cols="30" rows="10"><?php echo $bannerEdit['description']; ?></textarea>
                      </div>
                    </div>
                    <div class="form-group">
