<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:69:"D:\phpStudy\WWW\legou\public/../application/admin\view\banner\add.htm";i:1604592440;s:59:"D:\phpStudy\WWW\legou\application\admin\view\common\top.htm";i:1604586869;s:60:"D:\phpStudy\WWW\legou\application\admin\view\common\left.htm";i:1605340289;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
                ...
                <div id="horizontal-form">
                  <form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-6">
                        <input class="form-control" id="username" placeholder="" name="link_url"
                               type="text">
                      </div>
                      <p class="help-block col-sm-4 red">* 必填</p>
                    </div>
                      ...
                      <div class="col-sm-6">
                        <div class="radio">
                          <label style="margin-right: 20px">
                            <input name="type" value="1" type="radio" checked="checked" class="colored-blue">
                            <span class="text">商品</span>
                          </label>
                          <label>
                            <input name="type" value="2" type="radio" class="colored-blue">
